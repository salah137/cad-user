...
export default function View() {
    ...
    return <main
        className="w-[100vw] h-dvh bg-gradient-to-b from-[#5536F6] to-white   flex flex-col lg:flex-row md:flex-row justify-center items-center">
        ...
        } className="w-[50vw] lg:w-[30vw] p-3 bg-gradient-to-b from-[#F5A208] to-[#F1D49F] rounded-2xl flex flex-col justify-around h-[25vh] lg:h-[(0vh] md:h-[35vh]  m-5 hover:cursor-pointer">
