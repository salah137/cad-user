...
export default function View() {
    ...
    return <main
        ...
        } className="w-[50vw] lg:w-[30vw] p-3 bg-gradient-to-b from-[#a57b2d] to-[#F1D49F] rounded-2xl flex flex-col justify-around h-[25vh] lg:h-[50vh] md:h-[35vh]  m-5 hover:cursor-pointer">
